...
export function MiTerritorioModule() {
  ...
  if (isLoading) {
    return (
      <div className="flex h-[50vh] flex-col items-center justify-center gap-4 text-muted-foreground animate-in fade-in duration-500">
        ...
        <p className="font-medium">Cargando la información de su equipo...</p>
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col gap-6">
        ...
        <div className="rounded-xl border border-destructive/20 bg-destructive/10 p-6 text-center text-destructive">
          ...
          <p className="text-sm">
            {error?.message || "No parece estar asignado a ningún equipo activo actualmente. Por favor, comuníquese con su administrador si esto es un error."}
          </p>
        </div>
      </div>
    );
  ...
  const rawUsuarios = territorio.users || [];
  ...
  return (
    <div className="flex flex-col gap-8 animate-in fade-in duration-500 pb-20">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight mb-2">Mi Equipo</h1>
          <p className="text-muted-foreground">
            Consulta los detalles de asignación y miembros del equipo en el que te encuentras trabajando.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="col-span-1 lg:col-span-2 rounded-2xl border bg-card p-6 shadow-sm overflow-hidden relative">
          ...
          <div className="mb-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              {territorio.descripcion || "Este equipo aún no tiene una descripción detallada registrada en el sistema."}
            </p>
          </div>
        ...
        <div className="col-span-1 rounded-2xl border bg-gradient-to-br from-green-500/10 to-green-600/5 p-6 shadow-sm flex flex-col items-start relative overflow-hidden">
             ...
             <p className="text-sm text-muted-foreground mb-6 flex-1">
               Únase al grupo de comunicación oficial de WhatsApp para este equipo para mantenerse al tanto de las novedades y coordinar temas operativos.
             </p>
