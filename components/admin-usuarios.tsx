        ...
        <div className="flex flex-col gap-4">
          <div className="text-sm text-foreground leading-relaxed">
            ...
            <span className="font-semibold px-2 py-1 bg-muted rounded inline-block mt-2">
              Nombre Completo | Documento | Email | Celular | Contraseña | Rol | Equipo | Programa
            </span>
            <br/><br/>
            <div className="text-xs text-muted-foreground p-3 bg-muted/30 rounded-lg space-y-2 border border-border/50">
              ...
              <ul className="list-disc pl-4 space-y-1">
                ...
                <li>La columna <b>Equipo es obligatoria</b> para Auxiliar y Profesional. Indique el código o el nombre exacto de la lista (Ej. <i>E01</i> o <i>VILLA SANTANA</i>). Resto puede ir en blanco.</li>
      ...
      <div className="w-full max-w-[500px] rounded-2xl bg-card p-6 shadow-2xl relative overflow-y-auto max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {(rol === "auxiliar" || rol === "profesional") && (
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-semibold text-foreground">Equipo asignado</label>
              <select
                required
                value={territorioId}
          ...
          {rol === "facturador" && (
            <div className="flex flex-col gap-2">
              <label className="text-sm font-semibold text-foreground">Equipos asignados (Multiselección)</label>
              ...
              <p className="text-[10px] text-muted-foreground mt-1">
                Seleccione todos los equipos que el facturador podrá gestionar.
              </p>
            </div>
          )}
