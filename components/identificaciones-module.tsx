...
export function IdentificacionesModule() {
  ...
  return (
    <div className="flex flex-col gap-6 w-full pb-10">
        ...
        {!loading && (
          <div className="px-5 py-2 border-b border-border bg-card">
            <p className="text-sm text-muted-foreground font-medium">
              {pagination.totalCount} {pagination.totalCount === 1 ? "identificación encontrada" : "identificaciones encontradas"}
            </p>
          </div>
        )}
      ...
      {showDetailModal && (
        <div 
          className="fixed inset-0 z-[200] flex justify-center bg-black/40 backdrop-blur-sm p-4 animate-in fade-in duration-200 overflow-y-auto print:block print:static print:bg-white print:p-0 print:overflow-visible print:inset-auto"
          onClick={(e) => {
